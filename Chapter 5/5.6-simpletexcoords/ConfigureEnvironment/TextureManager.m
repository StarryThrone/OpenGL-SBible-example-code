    ...
    switch (target) {
        ...
        case GL_TEXTURE_2D: {
            ...
            for (int i = 0; i < h.miplevels; i++) {
                glTexImage2D(GL_TEXTURE_2D, i, h.glinternalformat, h.pixelwidth, h.pixelheight, 0, h.glformat, h.gltype, ptr);
        ...
        case GL_TEXTURE_2D_ARRAY:
            glTexImage3D(GL_TEXTURE_2D_ARRAY, h.miplevels, h.glinternalformat, h.pixelwidth, h.pixelheight, h.arrayelements, 0, h.glformat, h.gltype, data);
            break;
