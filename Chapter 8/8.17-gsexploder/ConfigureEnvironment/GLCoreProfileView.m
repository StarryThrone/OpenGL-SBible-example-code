...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    GLKMatrix4 scale_matrix = GLKMatrix4MakeScale(1, 1, 1);
    ...
    glUniformMatrix4fv(_projectionMatrixLocation, 1, GL_FALSE, proj_matrix.m);
...
- (BOOL)loadShaders {
    ...
    _mvMatrixLocation = glGetUniformLocation(_program, "mv_matrix");
